...
| 项 | 优先级 | 说明 |
|----|--------|------|
| Inline 插入格式 | P2 | 考虑更结构化的格式，便于 answer 引用：`[Image id=imgcap-0012 page=12 path=...]` |
| Separate caption 检索文本增强 | P2 | 可在 `page_content` 前缀加 `Page 12 image:` 或拼接 truncated context，提升召回 |
