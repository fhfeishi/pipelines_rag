...
Usage:
    uv run -m rag_pdfs.eval_img --questions tmp/eval_questions.jsonl --retrieve-only
    uv run -m rag_pdfs.eval_img --questions tmp/eval_questions.jsonl --alphas 0.3,0.5,0.7
"""
...
from rag_pdfs.hybrid_retrieve import HybridRetriever
from rag_pdfs.model_runtime import ModelRole
from rag_pdfs.query_img import (
    RetrievalMode,
    Strategy,
    build_answer_chain,
    build_context,
                ...
                for alpha in alpha_values:
                    ...
                    if retrieval == "hybrid":
                        ...
                        if cached_hybrid is None:
                            cached_hybrid = build_hybrid_retriever(
                                vectorstore,
                                index_dir=index_dir,
                                strategy=strategy,
                                embeddings=embeddings,
